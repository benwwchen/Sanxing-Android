...
public class LoginActivity extends AppCompatActivity {
    ...
    private void autoLogin() {
        showProgress(true);
        mAutoLoginTask = new AutoLoginTask(LoginActivity.this);
        mAutoLoginTask.execute((Void) null);
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                isSuccess = SanxingApiClient.getInstance(getApplicationContext()).loginAccount(mUserName, mPassword);
            } catch (Exception e) {
                return false;
            }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                String errorMessage = SanxingApiClient.getInstance(context).getMessage();
    ...
    public class AutoLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                isSuccess = SanxingApiClient.getInstance(getApplicationContext()).isLogin();
            } catch (Exception e) {
                return false;
            }
