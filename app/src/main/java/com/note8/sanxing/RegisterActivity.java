    ...
    public class UserRegisterTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                isSuccess = SanxingApiClient.getInstance(getApplicationContext())
                        .registerAccount(mUsername, mPassword);
            } catch (Exception e) {
                return false;
            }

            if (!isSuccess) mMessage = SanxingApiClient.getInstance(getApplicationContext())
                    .getMessage();
